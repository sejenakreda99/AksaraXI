          ...
          <div className="max-w-4xl mx-auto">
            ...
            <Card>
                ...
                <CardContent className="prose prose-sm max-w-none">
                    ...
                    <p>Novel Ronggeng Dukuh Paruk banyak mendeskrispikan situasi pedesaan di Jawa Tengah pada masa 1965. Harimau! Harimau! mendeskripsikan situasi hutan Sumatera. Sedangkan Upacara banyak mendeskipsikan adat budaya Suku Dayak di Kalimantan.</p>
                    ...
                    <div className="bg-slate-100 p-4 rounded-lg mt-6">
                        ...
                        <p className="text-muted-foreground italic">(Di halaman siswa, akan tersedia area untuk menuliskan hasil apresiasi mereka terhadap salah satu novel yang dipilih).</p>
                    </div>
